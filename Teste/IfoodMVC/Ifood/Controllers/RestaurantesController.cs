...
namespace Ifood.Controllers
{
    public class RestaurantesController : Controller
    {
        ...
        public RestaurantesController(IRestauranteService restauranteService, ISessao sessao, IWebHostEnvironment sistema, IProdutoService produtoService, IPedidoService pedidoService, IEnderecoService enderecoService)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetProdutos([FromRoute]int idRestaurante)
        {
        ...
        [Route("restaurante/CadastrarEndereco")]
        ...
        public async Task<IActionResult> CadastrarEndereco(EnderecoModel endereco)
        {
            try
            {
                RestauranteModel restaurante = new ();
                restaurante.Endereco = await enderecoService.SalvarEndereco(endereco);
                return View("Criar", restaurante);
            }catch(Exception ex)
            {
                return View();
            }
